...
if (hasInterface) then {
    ...
    private _hudTextW = format ["<t size='1.2' color='#ffffff'>%2</t><br/><t size='1.6' color='#dddddd'>West points: %1</t>", _pointsWHUD];

    private _pointsEHUD = missionNamespace getVariable ["globalEastBankBalance", 0];
    private _hudTextE = format ["<t size='1.2' color='#ffffff'>%2</t><br/><t size='1.6' color='#dddddd'>East points: %1</t>", _pointsEHUD];
