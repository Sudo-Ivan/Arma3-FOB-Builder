...
#define GET_CURRENT_PARAM_BY_INDEX(index) (CurrentBuilderParams select index)
#define GET_CURRENT_PARAM_BY_ID(id) GET_PARAM_BY_ID(CurrentBuilderParams, id)
...
#define PARAM_CATEGORY_BUILDER "Builder Configuration"
